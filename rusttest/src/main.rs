...
fn main() -> Result<(), ImageDataErrors> {
    let args = Args::new();
    let (image_1, image_formar_1) = find_image_from_path(args.image_1)?;
    let (image_2, image_formar_2) = find_image_from_path(args.image_2)?;

    if image_formar_1 != image_formar_2 {
